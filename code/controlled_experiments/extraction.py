...
def get_sentence_repr(
    ...
    print('Special Toks: ', special_tokens)
...
def extract_representations(model_name, input_corpus, output_file, device="cpu", aggregation="last", output_type="json", filter_vocab=None, model_path=None, limit_max_occurrences=-1, random_weights=False, ignore_embeddings=False, decompose_layers=True):
    print("Loading model")
...
def main():
    ...
    parser.add_argument("--decompose_layers", action="store_true", default=True)
