...
python compute_tcavs.py -b $base_activations -c $layer_wise_cav_pickle_path -o $output_directory -bs $base_path -bl $base_labels -w $word -rs $runs -m $model
